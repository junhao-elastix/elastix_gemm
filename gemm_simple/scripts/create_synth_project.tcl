...
set ac7t_lib_file       [file join $ACE_INSTALL_DIR/libraries/device_models "$device\_synplify.sv"]
...
switch [string trim $technology] {
    ...
    "AchronixSpeedster7t"    {  if { [file exists $ac7t_lib_file] } {
                                    # Normal default file
                                    add_file -verilog $ac7t_lib_file
                                } elseif { [file exists $ac7t1500_lib_file_v] && ($device == "AC7t1500ES0") } {
                                    # Should only occur with old ACE versions that don't have .sv file
                                    add_file -verilog $ac7t1500_lib_file_v
                                    puts "WARNING - Cannot find default file $ac7t_lib_file. Using $ac7t1500_lib_file_v"
                                } elseif { [file exists $ac7t1550_lib_file_v] && ($device == "AC7t1550") } {
                                    add_file -verilog $ac7t1550_lib_file_v
                                    puts "WARNING - Cannot find default file $ac7t_lib_file. Using $ac7t1550_lib_file_v"
                                } else {
                                    # Should only occur if incorrect or invalid device specified.
                                    add_file -verilog $ACE_INSTALL_DIR/libraries/device_models/7t_synplify.v
                                    puts "WARNING - Cannot find default file $ac7t_lib_file. Using $ACE_INSTALL_DIR/libraries/device_models/7t_synplify.v"
                                }
                             }
