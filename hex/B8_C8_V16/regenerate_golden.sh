...
# golden_B8_C8_V16_r_b.hex from left_r.hex and right_r_b.hex
...
echo "Regenerating golden files for B=8, C=8, V=16 (16 rows x 4 right blocks)"
echo "=============================================="
echo ""
...
for i in {0..15}; do
    ...
    for b in {0..3}; do
        ...
        GOLDEN_FILE="$HEX_DIR/golden_B8_C8_V16_${i}_${b}.hex"
