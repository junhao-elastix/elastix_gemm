...
# golden_B4_C16_V8_r_b.hex from left_r.hex and right_r_b.hex
...
echo "Regenerating golden files for B=4, C=16, V=8 (16 rows x 4 right blocks)"
echo "=============================================="
echo ""
...
for i in {0..15}; do
    ...
    for b in {0..3}; do
        ...
        GOLDEN_FILE="$HEX_DIR/golden_B4_C16_V8_${i}_${b}.hex"
