...
echo "Regenerating golden files for B=4, C=13, V=9"
echo "=============================================="
echo ""
...
for i in {0..15}; do
    ...
    GOLDEN_FILE="$HEX_DIR/golden_B4_C13_V9_${i}.hex"
    ...
    if [ $? -eq 0 ]; then
        echo "  ✓ Successfully generated tile $i"
    else
        echo "  ✗ Failed to generate tile $i"
    fi
    echo ""
done
