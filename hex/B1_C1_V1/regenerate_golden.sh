...
# golden_B1_C1_V1_r_b.hex from left_r.hex and right_r_b.hex
...
echo "Regenerating golden files for B=1, C=1, V=1 (16 rows x 4 right blocks)"
echo "=============================================="
echo ""
...
for i in {0..15}; do
    ...
    for b in {0..3}; do
        ...
        GOLDEN_FILE="$HEX_DIR/golden_B1_C1_V1_${i}_${b}.hex"
