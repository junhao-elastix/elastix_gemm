...
# golden_B2_C2_V2_r_b.hex from left_r.hex and right_r_b.hex
...
echo "Regenerating golden files for B=2, C=2, V=2 (16 rows x 4 right blocks)"
echo "=============================================="
echo ""
...
for i in {0..15}; do
    ...
    for b in {0..3}; do
        ...
        GOLDEN_FILE="$HEX_DIR/golden_B2_C2_V2_${i}_${b}.hex"
