...
//        This file can be automatically updated by a revision control system so that 
...
/*
    ...
    Version     Date        Author      Description
                MM.DD.YY
    1.0         05.07.25    JT          Initial release for VectorPath 815 card support
                                        Compatible with ACE 10.3.1 and SynplifyPro V-2023.09X
...
`define REVISON_CONTROL_VERSION 785565
