...
module acx_device_manager
  ...
  .ENABLE_ETH0_QUAD0_ANLT   (0),             // Enable ETH_0 Quad 0 ANLT
  .ENABLE_PCIE_RECONFIG_FPGA(1),             // Enable FPGA Reconfiguration Pin Control
  .ENABLE_ETH1_QUAD1_ANLT   (0),             // Enable ETH_1 Quad 1 ANLT
  .ENABLE_PCIE_0_PERSTN     (0),             // Enable PCIE_0 PERSTN Support
  .ENABLE_ETH1_QUAD0_ANLT   (0),             // Enable ETH_1 Quad 0 ANLT
  ...
  .ENABLE_ETH0_QUAD1_ANLT   (0),             // Enable ETH_0 Quad 1 ANLT
  ...
  (
   ...
   .i_eth0_quad0_an_link_good (4'h0),      // This must be connected to enable ANLT for ETH_0 Quad 0.
   .i_eth0_quad0_link_status (4'h0),       // This must be connected to enable ANLT for ETH_0 Quad 0.
   .i_eth0_quad0_link_status_ored (1'h0),  // This must be connected to enable ANLT for ETH_0 Quad 0
   .i_eth0_quad1_an_link_good (4'h0),      // This must be connected to enable ANLT for ETH_0 Quad 1.
   .i_eth0_quad1_link_status (4'h0),       // This must be connected to enable ANLT for ETH_0 Quad 1.
   .i_eth0_quad1_link_status_ored (1'h0),  // This must be connected to enable ANLT for ETH_0 Quad 1
   .i_eth1_quad0_an_link_good (4'h0),      // This must be connected to enable ANLT for ETH_1 Quad 0.
   .i_eth1_quad0_link_status (4'h0),       // This must be connected to enable ANLT for ETH_1 Quad 0.
   .i_eth1_quad0_link_status_ored (1'h0),  // This must be connected to enable ANLT for ETH_1 Quad 0
   .i_eth1_quad1_an_link_good (4'h0),      // This must be connected to enable ANLT for ETH_1 Quad 1.
   .i_eth1_quad1_link_status (4'h0),       // This must be connected to enable ANLT for ETH_1 Quad 1.
   .i_eth1_quad1_link_status_ored (1'h0),  // This must be connected to enable ANLT for ETH_1 Quad 1
   .o_eth0_quad0_an_link_status (),    // This must be connected to enable ANLT for ETH_0 Quad 0.
   .o_eth0_quad1_an_link_status (),    // This must be connected to enable ANLT for ETH_0 Quad 1.
   .o_eth1_quad0_an_link_status (),    // This must be connected to enable ANLT for ETH_1 Quad 0.
   .o_eth1_quad1_an_link_status (),    // This must be connected to enable ANLT for ETH_1 Quad 1.
