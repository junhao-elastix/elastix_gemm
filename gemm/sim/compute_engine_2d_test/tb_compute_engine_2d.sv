...
module tb_compute_engine_2d;
    ...
    test_config_t test_suite[] = '{
        // Single-file tests (legacy format)
        // '{C: 1,  V: 1,  B: 1,   name: "golden_B1_C1_V1",      multi_file: 0, row_id: 0},
        // '{C: 2,  V: 2,  B: 2,   name: "golden_B2_C2_V2",      multi_file: 0, row_id: 0},
        // '{C: 4,  V: 4,  B: 4,   name: "golden_B4_C4_V4",      multi_file: 0, row_id: 0},
        // '{C: 8,  V: 4,  B: 4,   name: "golden_B4_C8_V4",      multi_file: 0, row_id: 0},
        // '{C: 13, V: 9,  B: 4,   name: "golden_B4_C13_V9",     multi_file: 0, row_id: 0},
        // '{C: 16, V: 8,  B: 4,   name: "golden_B4_C16_V8",     multi_file: 0, row_id: 0},
        // '{C: 8,  V: 16, B: 8,   name: "golden_B8_C8_V16",     multi_file: 0, row_id: 0},
        // '{C: 16, V: 4,  B: 16,  name: "golden_B16_C16_V4",    multi_file: 0, row_id: 0},
        // '{C: 16, V: 8,  B: 16,  name: "golden_B16_C16_V8",    multi_file: 0, row_id: 0}

        // Multi-file test (B1_C64_V2 directory with left_X.hex, right_X_Y.hex, golden_B1_C64_V2_X_Y.hex)
        // Each right file is 128 NVs, with V=2 that's 64 cols/file × 4 files = 256 total columns
        '{C: 256, V: 2,  B: 1,   name: "B1_C64_V2",             multi_file: 1, row_id: 0}
    };
